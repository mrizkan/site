...
<section id="header">
  <div class="container">
    <div id="logo" class="col-lg-3 col-md-4 col-sm-4 col-xs-6"> <a href="index.html"><img src="images/logo.png" alt="Logo"/></a> </div>
    <div class="col-lg-9 col-md-8 col-sm-8 col-xs-6 top-navigation">
      <div class="navbar-header">
        <button type="button" class="navbar-toggle" data-toggle="collapse" data-target="#mobilemenu"> <span class="sr-only">Toggle navigation</span> <span class="icon-bar"></span> <span class="icon-bar"></span> <span class="icon-bar"></span> </button>
      </div>
      <div class="collapse navbar-collapse yamm">
        <ul class="nav navbar-nav">
          <li> <a href="#about">About</a> </li>
          <li> <a href="#meettheteam">Our Team</a> </li>
          <li> <a href="#projects">Projects</a> </li>
          <li> <a href="#causes">Causes</a> </li>
          <li> <a href="#newsandevents">News & Events</a> </li>
          <li> <a href="#contacts">Contacts</a> </li>
          <li class="highlighted"> <a href="#" data-toggle="modal" data-target=".donate_0">Donate</a> </li>
        </ul>
      </div>
    </div>
  </div>
...
<section id="slider">
  <div class="owl_slider top_slider_wrap">
    <ul class="owl-carousel top_slider">
      <li class="style-1" style="background-image: url(images/img_1.jpg);">
          ...
          <div class="container">
            <div class="content">
              ...
              <div class="description_wrap">
                <div class="description hidden-xs"> Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam nonummy nibh euismod tincidunt ut laoreet dolore magna aliquam erat volutpat. </div>
              </div>
              <a class="btn1" href="#">More Details</a> <a class="btn2" href="#" data-toggle="modal" data-target=".donate_0">Donate</a> </div>
          </div>
        </div>
      </li>
      <li class="style-2" style="background-image: url(images/img_2.jpg);">
        <div class="contentwrap">
          <div class="container">
            <div class="content">
      ...
      <li class="style-3" style="background-image: url(images/img_5.jpg);">
        <div class="contentwrap">
          <div class="container">
            <div class="content">
      ...
      <li class="style-4" style="background-image: url(images/img_6.jpg);">
        <div class="contentwrap">
          <div class="container">
            <div class="content">
      ...
      <li class="style-1" style="background-image: url(images/img_4.jpg);">
        <div class="contentwrap">
          <div class="container">
            <div class="content">
  ...
  <div class="container">
    ...
    <div class="row">
      <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
        ...
        <h4>Founded in 1988<br/>
          We give hope to the hopeless and helpless</h4>
      ...
      <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
        ...
        <div class="ourpoints">
          <div class="row point">
            <div class="icon-space"> <i class="fa fa-dot-circle-o fa-3x"></i> </div>
    ...
    <div class="row topspace">
      <div class="owl_slider team_slider_wrap">
        <ul class="owl-carousel team_slider">
          <li>
            <div class="image"> <img src="images/1_1.png" alt="Team Member"/> </div>
            <div class="name"> Particia Sidle </div>
            <div class="title"> Founder & CEO </div>
            <div class="social-icons">
              <div class="col-xs-10 centered"> <a href="http://www.facebook.com" target="_blank"><i class="fa fa-facebook-square fa-2x" aria-hidden="true"></i></a> <a href="http://www.twitter.com" target="_blank"><i class="fa fa-twitter-square fa-2x" aria-hidden="true"></i></a> <a href="http://www.linkedin.com" target="_blank"><i class="fa fa-linkedin-square fa-2x" aria-hidden="true"></i></a> <a href="mailto:someone@example.com" target="_blank"><i class="fa fa-envelope fa-2x" aria-hidden="true"></i></a> </div>
            </div>
          </li>
          <li>
            <div class="image"> <img src="images/2.png" alt="Team Member" /> </div>
            <div class="name"> Regina Cassandra </div>
            <div class="title"> E-Learning Manager </div>
            <div class="social-icons">
              <div class="col-xs-10 centered"> <a href="http://www.facebook.com" target="_blank"><i class="fa fa-facebook-square fa-2x" aria-hidden="true"></i></a> <a href="http://www.twitter.com" target="_blank"><i class="fa fa-twitter-square fa-2x" aria-hidden="true"></i></a> <a href="http://www.linkedin.com" target="_blank"><i class="fa fa-linkedin-square fa-2x" aria-hidden="true"></i></a> </div>
            </div>
          </li>
          <li>
            <div class="image"> <img src="images/3.png" alt="Team Member"/> </div>
            <div class="name"> Rhett Stocking </div>
            <div class="title"> Advertising Director </div>
            <div class="social-icons">
              <div class="col-xs-10 centered"> <a href="http://www.facebook.com" target="_blank"><i class="fa fa-facebook-square fa-2x" aria-hidden="true"></i></a> <a href="http://www.twitter.com" target="_blank"><i class="fa fa-twitter-square fa-2x" aria-hidden="true"></i></a> <a href="http://www.linkedin.com" target="_blank"><i class="fa fa-linkedin-square fa-2x" aria-hidden="true"></i></a> <a href="mailto:someone@example.com" target="_blank"><i class="fa fa-envelope fa-2x" aria-hidden="true"></i></a> </div>
            </div>
          </li>
          <li>
            <div class="image"> <img src="images/4.png" alt="Team Member"/> </div>
            <div class="name"> Daryl Walk </div>
            <div class="title"> E-Commerce Director </div>
            <div class="social-icons">
              <div class="col-xs-10 centered"> <a href="http://www.facebook.com" target="_blank"><i class="fa fa-facebook-square fa-2x" aria-hidden="true"></i></a> <a href="http://www.twitter.com" target="_blank"><i class="fa fa-twitter-square fa-2x" aria-hidden="true"></i></a> <a href="http://www.linkedin.com" target="_blank"><i class="fa fa-linkedin-square fa-2x" aria-hidden="true"></i></a> </div>
            </div>
          </li>
          <li>
            <div class="image"> <img src="images/5.png" alt="Team Member"/> </div>
            <div class="name"> Thurman Deck </div>
            <div class="title"> Hatchery Manager </div>
            <div class="social-icons">
              <div class="col-xs-10 centered"> <a href="http://www.facebook.com" target="_blank"><i class="fa fa-facebook-square fa-2x" aria-hidden="true"></i></a> <a href="http://www.twitter.com" target="_blank"><i class="fa fa-twitter-square fa-2x" aria-hidden="true"></i></a> <a href="http://www.linkedin.com" target="_blank"><i class="fa fa-linkedin-square fa-2x" aria-hidden="true"></i></a> </div>
            </div>
          </li>
          <li>
            <div class="image"> <img src="images/6.png" alt="Team Member"/> </div>
            <div class="name"> Julia Rolfe </div>
          ...
          <li>
            <div class="image"> <img src="images/7.png" alt="Team Member"/> </div>
            <div class="name"> Noel Toombs </div>
          ...
          <li>
            <div class="image"> <img src="images/8.png" alt="Team Member"/> </div>
            <div class="name"> Reginald Peyton </div>
            <div class="title"> Compensation Director </div>
            <div class="social-icons">
              <div class="col-xs-10 centered"> <a href="http://www.facebook.com" target="_blank"><i class="fa fa-facebook-square fa-2x" aria-hidden="true"></i></a> <a href="http://www.twitter.com" target="_blank"><i class="fa fa-twitter-square fa-2x" aria-hidden="true"></i></a> <a href="http://www.linkedin.com" target="_blank"><i class="fa fa-linkedin-square fa-2x" aria-hidden="true"></i></a> </div>
            </div>
          </li>
        ...
        <div class="owl_slider projects_slider_wrap">
          <ul class="owl-carousel projects_slider">
            <li>
              ...
              <h6>Nairobi, Kenya</h6>
              <p>Dolore magna aliquam erat volutpat. Ut wisi enim ad minim veniam, quis nostrud exerci tation ullamcorper suscipit lobortis nisl ut aliquip ex ea commodo consequat suscipit lobortis suscipi commodo</p>
              <a href="#" data-toggle="modal" data-target="#volunteerformModal" class="btn btn-primary">Volunteer for this project</a><a href="#" class="btn btn-secondary">Learn More</a> </li>
            <li>
    ...
    <div class="row topspace">
      <div class="owl_slider causes_slider_wrap">
        <ul class="owl-carousel causes_slider">
          <li>
            <div class="cause-wrap"> <img src="images/cause_education.png" alt="Cause Image"/>
              <div class="cause-title"> Education for the less fortunate </div>
              ...
              <div class="cause-bottom"> <a href="#" class="light-text" data-toggle="modal" data-target=".cause_1">View Details</a> | <span class="donate-link"><a href="#" data-toggle="modal" data-target=".donate_0">Donate</a></span> </div>
            </div>
          </li>
          <li>
            <div class="cause-wrap"> <img src="images/cause_refugees.jpg" alt="Cause Image"/>
              <div class="cause-title"> Food for children </div>
              <div class="cause-progress">
                <div class="progress">
              ...
              <div class="cause-bottom"> <a href="#" class="light-text" data-toggle="modal" data-target=".cause_2">View Details</a> | <span class="donate-link"><a href="#" data-toggle="modal" data-target=".donate_0">Donate</a></span> </div>
            </div>
          </li>
          <li>
            <div class="cause-wrap"> <img src="images/cause_street.jpg" alt="Cause Image"/>
              <div class="cause-title"> Home for street children </div>
              <div class="cause-progress">
                <div class="progress">
              ...
              <div class="cause-bottom"> <a href="#" class="light-text" data-toggle="modal" data-target=".cause_3">View Details</a> | <span class="donate-link"><a href="#" data-toggle="modal" data-target=".donate_0">Donate</a></span> </div>
            </div>
          </li>
          <li>
            <div class="cause-wrap"> <img src="images/cause_refugees.jpg" alt="Cause Image"/>
              <div class="cause-title"> Refugees assistance </div>
              <div class="cause-progress">
                <div class="progress">
                  <div class="progress-bar" role="progressbar" aria-valuenow="70" aria-valuemin="0" aria-valuemax="100" style="width:70%">70%</div>
                </div>
          ...
          <li>
            <div class="cause-wrap"> <img src="images/cause_medical.jpg" alt="Cause Image"/>
              <div class="cause-title"> Medical Care </div>
              <div class="cause-progress">
                <div class="progress">
          ...
          <li>
            <div class="cause-wrap"> <img src="images/cause_education.png" alt="Cause Image"/>
              <div class="cause-title"> War in Syria </div>
              <div class="cause-progress">
                <div class="progress">
                  <div class="progress-bar" role="progressbar" aria-valuenow="70" aria-valuemin="0" aria-valuemax="100" style="width:70%">70%</div>
                </div>
  ...
  <div class="modal fade cause_1" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-body"> <img src="images/education_big.jpg" alt="">
          <hr>
  ...
  <div class="container">
    ...
    <div class="row"> 
      ...
      <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12" id="latestnews">
        ...
        <div class="newsitem">
          <div class="row">
            <div class="col-lg-5 col-md-5 col-sm-5 col-xs-6"> <img src="images/news_1.png" alt=""> </div>
            <div class="col-lg-7 col-md-7 col-sm-7 col-xs-6">
              <div class="news-text-wrap">
                <div class="news-title">Latest news title </div>
                <div class="news-date">13 December 2016 </div>
                <div class="news-text">
        ...
        <div class="newsitem">
          <div class="row">
            <div class="col-lg-5 col-md-5 col-sm-5 col-xs-6"> <img src="images/news_2.png" alt=""> </div>
            <div class="col-lg-7 col-md-7 col-sm-7 col-xs-6">
              <div class="news-text-wrap">
                <div class="news-title">Latest news title </div>
                <div class="news-date">13 December 2016 </div>
      ...
      <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
        <div class="events-wrap">
          ...
          <div class="event-item">
            <div class="col-lg-2 col-md-2 col-sm-2 col-xs-2 event-date">23<br/>
  ...
  <div class="container">
    ...
    <div class="section-body">
      <div class="col-lg-3 col-md-3 col-sm-5 col-xs-10 centered contact-details">
        <div class="social-icons"> <a href="http://www.facebook.com" target="_blank"><i class="fa fa-facebook-square fa-3x" aria-hidden="true"></i></a> <a href="http://www.twitter.com" target="_blank"><i class="fa fa-twitter-square fa-3x" aria-hidden="true"></i></a> <a href="http://www.linkedin.com" target="_blank"><i class="fa fa-linkedin-square fa-3x" aria-hidden="true"></i></a> <a href="mailto:someone@example.com" target="_blank"><i class="fa fa-envelope fa-3x" aria-hidden="true"></i></a> </div>
        <div class="contacts"> <span class="details">Tel: +1 234 234 1234</span>
          <hr>
          <span class="details">Email: info@hopecharity.com</span> </div>
      </div>
      <div class="row">
        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
